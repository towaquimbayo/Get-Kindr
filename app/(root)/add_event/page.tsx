    ...
    return (
        <div id="bodyBox" className="flex flex-1 flex-col items-center bg-white w-full pb-12 pt-4">
            ...
            <div id="bodyContainer" className="flex flex-col w-10/12">
                ...
                <p id="subTitle" className="font-display font-bold text-secondary text-4xl max-w-xs sm:max-w-full md:max-w-2xl md:text-6xl lg:max-w-full mb-12 pl-6">Host the future of giving back.</p>
